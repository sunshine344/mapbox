 ...
 * @Author: xufeng
 * @Date: 2021-12-24 15:11:12
 * @LastEditTime: 2022-02-16 16:21:56
 * @FilePath: \cesium-s3m-demo\src\components\cesiumMap\js\entitys.js
 */
/**
 * entitys 实体类
 * 管理实体模型
...
export default class Entitys{
    ...
    getLabel(text,offset){
        return  new Cesium.LabelGraphics({ //文字标签
            ...
            pixelOffset: offset == undefined? new Cesium.Cartesian2(0, 0) : offset,
    ...
    getBillboard(img,width,height){
        return new Cesium.BillboardGraphics({
            image: img == undefined ? '../image/point-hover.png' : img,
