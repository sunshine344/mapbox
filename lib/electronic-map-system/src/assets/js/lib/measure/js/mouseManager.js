 ...
 * @Author: xufeng
 * @Date: 2021-12-24 15:11:02
 * @LastEditTime: 2022-02-17 15:06:33
 * @FilePath: \cesium-s3m-demo\src\components\cesiumMap\js\mouseManager.js
 */
 ...
 */
 ...
 export default class mouseManager{
     ...
     */
      ...
      * @Descripttion: 
      * @Author: 陈杰
      * @Date: 2022-02-17 11:13:03
      * @LastEditors: 
      * @param {*} e viewer.scene
      * @param {*} t position 获取移动点位
      * @param {*} i
      * @return {*}
      */     
     getCurrentMousePosition(e, t, i) {
        var _this = this;
        var a, n = e.pick(t);
        if (e.pickPositionSupported && Cesium.defined(n) && _this.cccc(n, i)) {
