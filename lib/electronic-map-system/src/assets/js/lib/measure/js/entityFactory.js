 ...
 * @LastEditTime: 2022-02-16 21:01:05
 */
...
export default class entityFactory{
    ...
    constructor(obj){
       ...
       switch(obj.type){
           ...
           case 'rectangle' :this.rectangle(obj.data);break;
    ...
    rectangle(obj){
        try {
            ...
            //实时更新polygon.hierarchy
            this.options.rectangle.hierarchy = new Cesium.CallbackProperty(_update,false);
        } catch (error) {
           console.log(error); 
        } 
